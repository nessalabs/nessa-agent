...
| [Opencode provider](../opencode-acp.md) | What is Opencode's own: a profile written from a recording, private process configuration, and the permission policy its launch pins |
